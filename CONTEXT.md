...
- **Bid Action Inspector**: The full-size modal window that opens upon selecting a bid row in the Bid & Offer Workspace, featuring mode-driven action tabs (`Accept Offer`, `Negotiate / Counter`, `Decline Offer`, `Timeline`) and a central TipTap-powered Email Builder with dynamic token population.
