...
export function TipTapTemplateEditor({
    ...
    switch (token) {
      ...
      case 'quick_bid_link':
        return {
          ...
          sampleValue: 'https://spoileralert.com/bid?token=secure-bidding-jwt'
        };
      default:
        return {
          token,
  ...
  const getCompiledPreview = () => {
    ...
    let compiledBody = bodyHtml
      ...
      .replace(/\{\{quick_bid_link\}\}/g, 'https://spoileralert.com/bid?token=demo-token-123');
